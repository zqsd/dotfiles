...
then
    if [ $(whoami) = "root" ]
    then
        PS1="$COLOR_BOLD$COLOR_BLUE[$COLOR_RED$COLOR_BG_CYAN\u$COLOR_RESET$COLOR_BOLD@$COLOR_GREEN$(hostname)$COLOR_RESET:$COLOR_BOLD$(pwd)$COLOR_BLUE]"
    else
        PS1="$COLOR_BOLD$COLOR_BLUE[$COLOR_RED\u$COLOR_RESET$COLOR_BOLD@$COLOR_GREEN$(hostname)$COLOR_RESET:$COLOR_BOLD$(pwd)$COLOR_BLUE]"
    fi
else
    if [ $(whoami) = "root" ]
    then
        PS1="$COLOR_BOLD$COLOR_BLUE[$COLOR_BG_CYAN$COLOR_RED\u$COLOR_RESET$COLOR_BOLD$COLOR_RESET:$COLOR_BOLD$(pwd)$COLOR_BLUE]"
    fi
fi
